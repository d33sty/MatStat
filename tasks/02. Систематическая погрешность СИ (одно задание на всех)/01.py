...
# квантили
t_student = stats.t.ppf(0.975, df=n1-1)  # квантиль Стьюдента с df=9 (фиксированное значение)
chi2_value = stats.chi2.ppf(0.975, df=n2-1)  # квантиль хи-квадрат с df=19 (фиксированное значение)
...
print(f"Результат измерения чистого сигнала: H_ist = ({H_ist:.2e} +- {delta_H_ist:.2e}) Зв/ч, p = 0.95")
...
print(f"Полная погрешность систематической составляющей: Delta_сист,полн = {delta_sist_full:.2e} Зв/ч")